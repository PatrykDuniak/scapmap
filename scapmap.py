...
parser.add_argument('--noverify', action='store_false', help="Allow to connect to site with self-signed certificate or or completely without it")
parser.add_argument('--diffdomain', action='store_false', help="Get links form site that are not related to specific domain")
